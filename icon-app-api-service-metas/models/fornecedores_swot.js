'use strict';
const { swot_oportunidades, swot_ameacas } = require("../core/models/analiseDataModels/Fornecedor")
const { Swot_Intensidade } = require("../core/models/analise_data")

module.exports = (sequelize, DataTypes) => {
  const Fornecedores_Swot = sequelize.define('Fornecedores_Swot', {
    oportunidadeId: {
  ...
  Fornecedores_Swot.associate = function (models) {
  };
  return Fornecedores_Swot;
};